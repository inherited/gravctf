...
MACRO_TUNING_PARAM(grenade_curvature, 0.0f)
...
MACRO_TUNING_PARAM(gravity, 0.2f)
MACRO_TUNING_PARAM(gravity_factor, 500.0f)
MACRO_TUNING_PARAM(gravity_power, 0.5f)


//MACRO_TUNING_PARAM(gravx, 0.0f)
//MACRO_TUNING_PARAM(gravy, 0.5f)
